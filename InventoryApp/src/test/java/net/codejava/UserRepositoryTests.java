...
public class UserRepositoryTests {
	...
	public void testCreateNewUserWithOneRole() {
		...
		User user = new User("sharif@gmail.com", "sharif2020");
	...
	public void testCreateNewUserWithTwoRoles() {
		...
		User user = new User("arif@gamil.com", "arif2020");
	...
	@Test
	public void testCreateNewUserNewRole() {
		Role roleSalesperson = new Role("Salesperson");
		User user = new User("oliv@gmail.com", "oliv2020");
